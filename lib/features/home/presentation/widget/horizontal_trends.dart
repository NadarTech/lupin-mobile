...
class HorizontalTrends extends StatelessWidget {
  final List<TrendVideoModel> horizontalTrends;

  const HorizontalTrends({super.key, required this.horizontalTrends});
  ...
  Widget build(BuildContext context) {
    return GridView.builder(
      ...
      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
        crossAxisCount: 1,
        childAspectRatio: 1182 / 780,
        crossAxisSpacing: 24.w,
        mainAxisSpacing: 24.h,
      ),
      itemCount: horizontalTrends.length,
      itemBuilder: (context, index) {
        final trendVideo = horizontalTrends[index];
